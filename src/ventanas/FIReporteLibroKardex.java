...
public class FIReporteLibroKardex extends MaestroInternalFrame{
	...
	private static FIReporteLibroKardex gui=null;
	...
	public static FIReporteLibroKardex createInstance() {
		if (gui == null) {
			gui = new FIReporteLibroKardex();
		}
		return gui;
	}

	public static FIReporteLibroKardex getInstance() {
		return gui;
	}
	
	public FIReporteLibroKardex() {
		//initialize();
	}
	
	public void initialize() {
		setSize(321, 108);
		setTitle(Sesion.titulo+"-"+Sesion.tifReporteLibroKardex);
		//
