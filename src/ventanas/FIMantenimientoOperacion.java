...
public class FIMantenimientoOperacion extends MaestroInternalFrame {
	...
	public FIMantenimientoOperacion() {

		setSize(507, 400);
		setTitle(getTitle() + "-" + Sesion.tifOperacion);
		//
	...
	public void cargarTabla(List<Operacion> operaciones) {
		limpiarTabla();
		for (Operacion operacion : operaciones) {
			Object datos[] = { operacion.getCodigo(),
					operacion.getDescripcion() };
			dtm.addRow(datos);
		}
	}

	public void cargarTabla(Operacion operacion) {
		limpiarTabla();
		Object datos[] = { operacion.getCodigo(), operacion.getDescripcion() };
		dtm.addRow(datos);
	}
