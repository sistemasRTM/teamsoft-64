...
public class FIMantenimientoPerfil extends MaestroInternalFrame {
	...
	public FIMantenimientoPerfil() {
		setSize(507, 400);
		setTitle(getTitle() + "-" + Sesion.tifPerfil);
		//
	...
	public void cargarTabla(List<Perfil> perfiles) {
		limpiarTabla();
		for (Perfil perfil : perfiles) {
			Object datos[] = { perfil.getCodigo(),
					perfil.getDescripcion() };
			dtm.addRow(datos);
		}
	}

	public void cargarTabla(Perfil perfil) {
		limpiarTabla();
		Object datos[] = { perfil.getCodigo(), perfil.getDescripcion() };
		dtm.addRow(datos);
	}
