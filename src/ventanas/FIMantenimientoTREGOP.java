...
public class FIMantenimientoTREGOP extends MaestroInternalFrame{
	...
	private String[] cabecera={"id","C\u00F3digo","Tipo","Movimiento","Sit."};
	...
	private int id;
	public FIMantenimientoTREGOP() {
		setSize(443, 410);
		
		toolBar.setVisible(true);
	
		setTitle(getTitle() + "-" + Sesion.tifRegistroOperacion);
		pnDatos = new JPanel();
		...
		lblTipoDeRegistro = new JLabel("Tipo");
		lblTipoDeRegistro.setBounds(61, 18, 158, 14);
		pnDatos.add(lblTipoDeRegistro);
		...
		txtDTipo.setBounds(61, 35, 175, 20);
		pnDatos.add(txtDTipo);
		
		txtDMovimiento = new JTextField();
		txtDMovimiento.setBounds(244, 35, 93, 20);
	...
	public void limpiarTabla() {
		...
		TableColumn colTipo = tbBusqueda.getColumn(2);
		TableColumn colMovimiento = tbBusqueda.getColumn(3);
		TableColumn colSit = tbBusqueda.getColumn(4);
		
		colCodigo.setPreferredWidth(50);
		colTipo.setPreferredWidth(150);
		colMovimiento.setPreferredWidth(70);
	...
	public void cargarTabla(List<TREGOP> listado) {
		limpiarTabla();
		for (TREGOP  obj : listado) {
			Object datos[] = {obj.getId(), obj.getCodigo(),obj.getTipo(),obj.getMovimiento(),obj.getSituacion()};
			dtm.addRow(datos);
		}
	}
	
	public void cargarTabla(TREGOP  obj) {
		limpiarTabla();
		Object datos[] = {obj.getId(), obj.getCodigo(),obj.getTipo(),obj.getMovimiento(),obj.getSituacion()};
		dtm.addRow(datos);
	}
