...
*/
	...
	public ArrayList<String[]> reporteVentasEjercicio(int ejer) {
		...
		String[] cabecera = {"Codigo","Cliente","Dirección","Distrito","Departamento","Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Setiembre","Octubre","Noviembre","Diciembre","Total"};  // primera fila es la cabecera o titulos de las columnas
		filas.add(cabecera);
